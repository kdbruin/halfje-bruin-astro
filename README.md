...
<div align="center">
  ...
  <img alt="License" src="https://img.shields.io/github/license/kdbruin/halfje-bruin-astro?style=flat-square&color=5e17eb&labelColor=000000">
...
**Note:** Use `npx degit kdbruin/halfje-bruin-astro` to clone the template without any of the `git` history
