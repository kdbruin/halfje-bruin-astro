...
<DefaultPageLayout content={{ title: frontmatter.title, description: frontmatter.description }}>
    <Prose>
            ...
            **Astro-ink** strives to remain minimal & performant while still offering you all the bells and whistles you expect in a personal blog system. Please check the [README](https://github.com/kdbruin/halfje-bruin-astro/blob/main/README.md) to know about all the features. 
